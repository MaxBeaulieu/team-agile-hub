...
// Temporary: QuickRetro is the only feature in use right now, so send
// everyone straight there instead of the marketing/hero page below. proxy.ts
// still treats "/" as a public route, so unauthenticated visitors land here,
// get redirected to /quickretro, and — since that's not public — proxy.ts
// then sends them to /auth/login?next=/quickretro and back after signing in.
// The original landing page is commented out below, not deleted, so it's a
// one-line revert (delete this function, uncomment the rest) once more
// features are ready.
